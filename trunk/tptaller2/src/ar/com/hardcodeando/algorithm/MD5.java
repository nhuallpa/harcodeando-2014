...
class MD5 {
	...
	private static void transform(long lngState[], char bytBlock[]) {
		...
		if (pasos == 16) {
			System.out.println("FF A " + lngA + "FF D " + lngD + "FF C " + lngC + "FF B " + lngB);
		}
		...
		if (pasos == 16) {
			System.out.println("GG A " + lngA + "GG D " + lngD + "GG C " + lngC + "GG B " + lngB);
		}
		...
		if (pasos == 16) {
			System.out.println("HH A " + lngA + "HH D " + lngD + "HH C " + lngC + "HH B " + lngB);
		}
		...
		System.out.println("A = A + AA " + lngState[0]);
		System.out.println("B = B + BB " + lngState[1]);
		System.out.println("C = C + CC " + lngState[2]);
		System.out.println("D = D + DD " + lngState[3]);
